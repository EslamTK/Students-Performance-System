...
class StudentReviewRepo(Repo):
    ...
    def get_educator_reviews_departments(self, educator):
        departments = StudentReview.objects.filter(educator=educator) \
